-- =====================================================
-- INVENTORY AUTO DEDUCTION SYSTEM (SIMPLE VERSION)
-- Version: 1.0
-- Date: 2025-01-15
-- Description: Sistem otomatis mengurangi stok bahan ketika order berubah status
-- Sesuai dengan struktur tabel inventory_movements yang sebenarnya
-- =====================================================
...
BEGIN
    ...
    INSERT INTO inventory_movements (
        ...
        'keluar',
        p_quantity::INTEGER,
        COALESCE(p_notes, 'Auto deduction for order: ' || p_order_id::TEXT),
        NULL
...
COMMENT ON FUNCTION record_inventory_movement(UUID, DECIMAL, UUID, TEXT) IS 
