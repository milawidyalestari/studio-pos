-- =====================================================
-- TEST SCRIPT: Inventory Auto Deduction System
...
('44444444-4444-4444-4444-444444444444', 'Kertas Foto', 'lembar', 200, 20, 2000)
...
('cccccccc-cccc-cccc-cccc-cccccccccccc', 'PRD003', 'Print Foto 4R', 'Print', 3000)
ON CONFLICT (id) DO NOTHING;
...
('cccccccc-cccc-cccc-cccc-cccccccccccc', '44444444-4444-4444-4444-444444444444', 1.0)   -- 1 lembar kertas foto
...
-- Buat order items
INSERT INTO order_items (order_id, item_id, item_name, quantity, unit_price, sub_total) VALUES
('66666666-6666-6666-6666-666666666666', 'cccccccc-cccc-cccc-cccc-cccccccccccc', 'Print Foto 4R', 4, 2000, 8000)
ON CONFLICT DO NOTHING;
...
-- =====================================================
-- TEST 9: Test Insufficient Stock Scenario
-- =====================================================
RAISE NOTICE '=== TEST 9: Test Insufficient Stock Scenario ===';

-- Buat order dengan quantity besar untuk test insufficient stock
INSERT INTO orders (
    id, order_number, customer_name, tanggal, total_amount, status_id
) VALUES (
    '77777777-7777-7777-7777-777777777777',
    'TEST-INV-003',
    'Test Customer Large Order',
    CURRENT_DATE,
    200000,
    1  -- Unnest status
) ON CONFLICT (id) DO NOTHING;

-- Buat order items dengan quantity besar
INSERT INTO order_items (order_id, item_id, item_name, quantity, unit_price, sub_total) VALUES
('77777777-7777-7777-7777-777777777777', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'Print A4 Hitam Putih', 2000, 2000, 4000000)
ON CONFLICT DO NOTHING;

-- Cek ketersediaan stok untuk order besar
SELECT * FROM check_stock_availability('77777777-7777-7777-7777-777777777777');
...
DELETE FROM inventory_movements WHERE keterangan LIKE '%order: 55555555-5555-5555-5555-555555555555%' 
   ...
   OR keterangan LIKE '%order: 77777777-7777-7777-7777-777777777777%';
