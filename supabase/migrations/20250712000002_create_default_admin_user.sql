-- Create default admin user in employees table
-- This migration adds a default administrator user for first-time setup
...
-- Also insert into roles table if not exists
