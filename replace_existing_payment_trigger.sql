-- =====================================================
-- REPLACE EXISTING PAYMENT UPDATE TRIGGER
-- Version: 1.0
-- Date: 2025-01-15
-- Description: Script untuk mengganti trigger payment_update yang sudah ada
-- dengan versi yang lebih robust sesuai struktur tabel orders yang sebenarnya
-- =====================================================
...
WHERE tablename = 'orders' AND triggername = 'trigger_update_payment_update_enhanced';
