-- =====================================================
-- SETUP SCRIPT: Payment Method Debit/Credit Accounts
-- Run this in Supabase SQL Editor after main setup
-- =====================================================

-- Step 1: Add new columns to payment_method_accounts
-- =====================================================
...
-- Step 4: Update view to include new columns
...
-- Step 5: Update function to handle debit/credit accounts
...
-- Step 6: Create function to get debit/credit accounts
...
-- Step 7: Update existing payment methods with proper mapping
...
-- Test function
SELECT * FROM get_debit_credit_accounts_for_payment_method('cash');
SELECT * FROM get_debit_credit_accounts_for_payment_method('transfer');
SELECT * FROM get_debit_credit_accounts_for_payment_method('credit');
