...
-- Step 11: Create RLS policies (allow all for authenticated users)
...
-- Step 12: Insert default chart of accounts data
...
-- Step 13: Insert default cash account
