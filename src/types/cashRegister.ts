...
export const CASH_REGISTER_PRESETS: Record<string, CashRegisterConfig> = {
  ...
  // Studio Printing Specific - Brother QL-820NWB
  'brother-ql820nwb': {
    id: 'brother-ql820nwb',
    ...
    commands: {
      ...
      printQRCode: (data: string) => `\x1D\x28\x6B\x04\x00\x31\x41\x32\x00${data}`,
      custom: {
        printLabel: '\x1B\x69\x41\x01',
        printReceipt: '\x1B\x69\x41\x00'
      }
    },
    settings: {
      paperWidth: 62,
      ...
      characterSet: 'cp437',
      fontType: 'font-a',
      receiptHeader: 'STUDIO PRINTING SERVICES',
      receiptFooter: 'Quality printing at your service!',
      autoPrint: true,
      autoCut: true,
  ...
  // Studio Printing Specific - Epson TM-T88VI
  'epson-tm-t88vi': {
    id: 'epson-tm-t88vi',
    name: 'Epson TM-T88VI',
    manufacturer: 'Epson',
    ...
    settings: {
      ...
      fontType: 'font-a',
      receiptHeader: 'STUDIO PRINTING SERVICES',
      receiptFooter: 'Professional printing solutions!',
      autoPrint: true,
      autoCut: true,
      autoOpenDrawer: true,
      displayEnabled: false,
  ...
  // Studio Printing Specific - Citizen CT-S310II
  'citizen-ct-s310ii': {
    ...
    settings: {
      ...
      fontType: 'font-a',
      receiptHeader: 'STUDIO PRINTING SERVICES',
      receiptFooter: 'Fast and reliable printing!',
      autoPrint: true,
      autoCut: true,
      autoOpenDrawer: true,
      displayEnabled: false,
