              ...
              {isLoadingList ? (
                ...
                filteredList.map((item) => (
                  ...
                  >
                    ...
                    {items ? <span className="w-24 text-center font-medium">{item.stok_akhir !== null && item.stok_akhir !== undefined && item.stok_akhir !== '' ? item.stok_akhir.toString() : '-'}</span> : <span>{item.satuan}</span>}
